    ...
    public static void move(Organisms[][] grid, int i, int j) {
        if (grid[i][j] instanceof Animal) {
            if ((i - 1) >= 0 && (j - 1) >= 0) {
                ...
                else if (grid[i - 1][j - 1] == null && ( grid[i][j].lastVisited(i-1, j-1) > 2  || grid[i][j].lastVisited(i-1, j-1) ==  0) ) {
                    grid[i][j].setVisited(i-1, j-1);
                    grid[i][j].setVisited(i,j);
                    grid[i][j].setEnergy(-2);
                    grid[i - 1][j - 1] = grid[i][j];
                ...
                else if (grid[i - 1][j] == null && (grid[i][j].lastVisited(i-1, j ) > 2 || grid[i][j].lastVisited(i-1, j ) == 0)) {
                    grid[i][j].setVisited(i-1, j);
                    grid[i][j].setVisited(i,j);
               ...
               else if (grid[i][j - 1] == null  && (grid[i][j].lastVisited(i, j-1 ) > 2 || grid[i][j].lastVisited(i, j-1 ) == 0)) {
                    grid[i][j].setVisited(i, j-1);
                    grid[i][j].setVisited(i,j);
                    grid[i][j].setEnergy(-1);
                    grid[i][j - 1] =  grid[i][j];
               ...
               if (grid[i][j + 1] instanceof Plant && grid[i][j] instanceof Herbivore ) {
                ...
                else if (grid[i + 1][j - 1] == null&& (j - 1) >= 0 && ( grid[i][j].lastVisited(i+1, j-1 ) > 2 || grid[i][j].lastVisited(i+1, j-1 ) == 0 ) ) {
                    grid[i][j].setVisited(i+1, j);
                    grid[i][j].setVisited(i,j);
                    grid[i][j].setEnergy(-1);
                    grid[i + 1][j - 1] =  grid[i][j];
